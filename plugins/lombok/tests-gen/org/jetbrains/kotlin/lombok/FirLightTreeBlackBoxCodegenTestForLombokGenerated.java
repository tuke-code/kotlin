...
public class FirLightTreeBlackBoxCodegenTestForLombokGenerated extends AbstractFirLightTreeBlackBoxCodegenTestForLombok {
  ...
  @Test
  @TestMetadata("customBuilderOnConstructors.kt")
  public void testCustomBuilderOnConstructors() {
    runTest("plugins/lombok/testData/box/customBuilderOnConstructors.kt");
  }
