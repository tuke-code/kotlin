...
interface IrDeclarationOrigin {
    ...
    companion object {
        ...
        val FUNCTION_FOR_DEFAULT_PARAMETER by _Synthetic
        val MASK_FOR_DEFAULT_FUNCTION by _Synthetic
        val DEFAULT_CONSTRUCTOR_MARKER by _Synthetic
        val METHOD_HANDLER_IN_DEFAULT_FUNCTION by _Synthetic
        ...
        val SYNTHETIC_FILE_CLASS by _Synthetic
        ...
        val BRIDGE by _Synthetic
        val BRIDGE_SPECIAL by _IrDeclarationOriginImpl
        val GENERATED_SETTER_GETTER by _Synthetic

        val FIELD_FOR_ENUM_ENTRY by _IrDeclarationOriginImpl
        val SYNTHETIC_HELPER_FOR_ENUM_VALUES by _Synthetic
        val SYNTHETIC_HELPER_FOR_ENUM_ENTRIES by _Synthetic
        val FIELD_FOR_ENUM_VALUES by _Synthetic
        val FIELD_FOR_ENUM_ENTRIES by _Synthetic
        val PROPERTY_FOR_ENUM_ENTRIES by _IrDeclarationOriginImpl
        val FIELD_FOR_OBJECT_INSTANCE by _IrDeclarationOriginImpl
        val FIELD_FOR_CLASS_CONTEXT_RECEIVER by _Synthetic

        val ADAPTER_FOR_CALLABLE_REFERENCE by _Synthetic
        val ADAPTER_PARAMETER_FOR_CALLABLE_REFERENCE by _IrDeclarationOriginImpl
        val ADAPTER_FOR_SUSPEND_CONVERSION by _Synthetic
        val ADAPTER_PARAMETER_FOR_SUSPEND_CONVERSION by _IrDeclarationOriginImpl
        val ADAPTER_FOR_FUN_INTERFACE_CONSTRUCTOR by _Synthetic

        val GENERATED_SAM_IMPLEMENTATION by _IrDeclarationOriginImpl
        val SYNTHETIC_GENERATED_SAM_IMPLEMENTATION by _Synthetic

        val SYNTHETIC_JAVA_PROPERTY_DELEGATE by _Synthetic

        val FIELD_FOR_OUTER_THIS by _Synthetic
        val CONTINUATION by _Synthetic
        val LOWERED_SUSPEND_FUNCTION by _Synthetic

        val SHARED_VARIABLE_IN_EVALUATOR_FRAGMENT by _Synthetic
         ...
         */
        val SYNTHETIC_ACCESSOR by _Synthetic
    }
