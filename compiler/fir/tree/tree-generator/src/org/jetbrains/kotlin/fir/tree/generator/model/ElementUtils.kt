...
fun field(
    ...
    val isMutable = if (type is org.jetbrains.kotlin.generators.tree.ElementOrRef<*>) true else withReplace
...
fun field(
    ...
    val name = when (type) {
        ...
        is org.jetbrains.kotlin.generators.tree.ElementOrRef<*> -> type.element.name
