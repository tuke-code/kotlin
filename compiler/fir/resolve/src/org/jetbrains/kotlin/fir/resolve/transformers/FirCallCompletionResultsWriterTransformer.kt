...
import org.jetbrains.kotlin.resolve.calls.inference.model.NoInferInvolvedWarning
...
class FirCallCompletionResultsWriterTransformer(
    ...
    private fun FirQualifiedAccessExpression.addNonFatalDiagnostics(calleeReference: FirNamedReferenceWithCandidate) {
        ...
        if (calleeReference.hasNoInferInvolvedWarnings()) {
            addNonFatalDiagnostic(ConeNoInferInvolved)
        }
    }
    ...
    private fun FirNamedReferenceWithCandidate.hasNoInferInvolvedWarnings(): Boolean =
        candidate.system.errors.any { it is NoInferInvolvedWarning }
