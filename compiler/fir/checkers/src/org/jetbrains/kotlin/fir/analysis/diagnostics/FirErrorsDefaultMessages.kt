...
//            map.put(ILLEGAL_PROJECTION_USAGE, ...) // &
        ...
        map.put(CAN_BE_VAL, "This 'var' property is never written to, so it can be declared as 'val'.")
        map.put(CAN_BE_VAL_LATEINIT, "This 'lateinit var' property is never written to more than once, so it can be declared as nullable 'val'.")
        map.put(CAN_BE_VAL_DELAYED_INITIALIZATION, "This 'var' property is never written to more than once, so it can be declared as 'val'.")
