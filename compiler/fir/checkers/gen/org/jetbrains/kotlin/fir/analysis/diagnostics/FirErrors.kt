...
object FirErrors {
    ...
    val OTHER_ERROR_WITH_REASON: KtDiagnosticFactory1<String> by error1<PsiElement, String>()
    ...
    val SEALED_SUPERTYPE_IN_LOCAL_CLASS: KtDiagnosticFactory2<String, ClassKind> = KtDiagnosticFactory2("SEALED_SUPERTYPE_IN_LOCAL_CLASS", ERROR, SourceElementPositioningStrategies.DEFAULT, KtTypeReference::class)
    val SEALED_INHERITOR_IN_DIFFERENT_PACKAGE: KtDiagnosticFactory0 = KtDiagnosticFactory0("SEALED_INHERITOR_IN_DIFFERENT_PACKAGE", ERROR, SourceElementPositioningStrategies.DEFAULT, KtTypeReference::class)
    val SEALED_INHERITOR_IN_DIFFERENT_MODULE: KtDiagnosticFactory0 = KtDiagnosticFactory0("SEALED_INHERITOR_IN_DIFFERENT_MODULE", ERROR, SourceElementPositioningStrategies.DEFAULT, KtTypeReference::class)
    val CLASS_INHERITS_JAVA_SEALED_CLASS: KtDiagnosticFactory0 = KtDiagnosticFactory0("CLASS_INHERITS_JAVA_SEALED_CLASS", ERROR, SourceElementPositioningStrategies.DEFAULT, KtTypeReference::class)
    ...
    val SUPERTYPE_NOT_INITIALIZED: KtDiagnosticFactory0 = KtDiagnosticFactory0("SUPERTYPE_NOT_INITIALIZED", ERROR, SourceElementPositioningStrategies.DEFAULT, KtTypeReference::class)
    ...
    val INVALID_TYPE_OF_ANNOTATION_MEMBER: KtDiagnosticFactory0 = KtDiagnosticFactory0("INVALID_TYPE_OF_ANNOTATION_MEMBER", ERROR, SourceElementPositioningStrategies.DEFAULT, KtTypeReference::class)
    ...
    val NULLABLE_TYPE_OF_ANNOTATION_MEMBER: KtDiagnosticFactory0 = KtDiagnosticFactory0("NULLABLE_TYPE_OF_ANNOTATION_MEMBER", ERROR, SourceElementPositioningStrategies.DEFAULT, KtTypeReference::class)
    ...
    val EXPOSED_RECEIVER_TYPE: KtDiagnosticFactory3<EffectiveVisibility, FirBasedSymbol<*>, EffectiveVisibility> = KtDiagnosticFactory3("EXPOSED_RECEIVER_TYPE", ERROR, SourceElementPositioningStrategies.DEFAULT, KtTypeReference::class)
    ...
    val VALUE_CLASS_HAS_INAPPLICABLE_PARAMETER_TYPE: KtDiagnosticFactory1<ConeKotlinType> = KtDiagnosticFactory1("VALUE_CLASS_HAS_INAPPLICABLE_PARAMETER_TYPE", ERROR, SourceElementPositioningStrategies.DEFAULT, KtTypeReference::class)
    ...
    val VALUE_CLASS_CANNOT_EXTEND_CLASSES: KtDiagnosticFactory0 = KtDiagnosticFactory0("VALUE_CLASS_CANNOT_EXTEND_CLASSES", ERROR, SourceElementPositioningStrategies.DEFAULT, KtTypeReference::class)
    val VALUE_CLASS_CANNOT_BE_RECURSIVE: KtDiagnosticFactory0 = KtDiagnosticFactory0("VALUE_CLASS_CANNOT_BE_RECURSIVE", ERROR, SourceElementPositioningStrategies.DEFAULT, KtTypeReference::class)
    ...
    val TYPE_ARGUMENT_ON_TYPED_VALUE_CLASS_EQUALS: KtDiagnosticFactory0 = KtDiagnosticFactory0("TYPE_ARGUMENT_ON_TYPED_VALUE_CLASS_EQUALS", ERROR, SourceElementPositioningStrategies.DEFAULT, KtTypeReference::class)
    ...
    val FINAL_UPPER_BOUND: KtDiagnosticFactory1<ConeKotlinType> = KtDiagnosticFactory1("FINAL_UPPER_BOUND", WARNING, SourceElementPositioningStrategies.DEFAULT, KtTypeReference::class)
    val UPPER_BOUND_IS_EXTENSION_FUNCTION_TYPE: KtDiagnosticFactory0 = KtDiagnosticFactory0("UPPER_BOUND_IS_EXTENSION_FUNCTION_TYPE", ERROR, SourceElementPositioningStrategies.DEFAULT, KtTypeReference::class)
    ...
    val ONLY_ONE_CLASS_BOUND_ALLOWED: KtDiagnosticFactory0 = KtDiagnosticFactory0("ONLY_ONE_CLASS_BOUND_ALLOWED", ERROR, SourceElementPositioningStrategies.DEFAULT, KtTypeReference::class)
    val REPEATED_BOUND: KtDiagnosticFactory0 = KtDiagnosticFactory0("REPEATED_BOUND", ERROR, SourceElementPositioningStrategies.DEFAULT, KtTypeReference::class)
    ...
    val BOUND_ON_TYPE_ALIAS_PARAMETER_NOT_ALLOWED: KtDiagnosticFactory0 = KtDiagnosticFactory0("BOUND_ON_TYPE_ALIAS_PARAMETER_NOT_ALLOWED", ERROR, SourceElementPositioningStrategies.DEFAULT, KtTypeReference::class)
    ...
    val DYNAMIC_SUPERTYPE: KtDiagnosticFactory0 = KtDiagnosticFactory0("DYNAMIC_SUPERTYPE", ERROR, SourceElementPositioningStrategies.DEFAULT, KtTypeReference::class)
    val DYNAMIC_UPPER_BOUND: KtDiagnosticFactory0 = KtDiagnosticFactory0("DYNAMIC_UPPER_BOUND", ERROR, SourceElementPositioningStrategies.DEFAULT, KtTypeReference::class)
    ...
    val REDUNDANT_NULLABLE: KtDiagnosticFactory0 = KtDiagnosticFactory0("REDUNDANT_NULLABLE", WARNING, SourceElementPositioningStrategies.REDUNDANT_NULLABLE, KtTypeReference::class)
    ...
    val INCORRECT_LEFT_COMPONENT_OF_INTERSECTION: KtDiagnosticFactory0 = KtDiagnosticFactory0("INCORRECT_LEFT_COMPONENT_OF_INTERSECTION", ERROR, SourceElementPositioningStrategies.DEFAULT, KtTypeReference::class)
    val INCORRECT_RIGHT_COMPONENT_OF_INTERSECTION: KtDiagnosticFactory0 = KtDiagnosticFactory0("INCORRECT_RIGHT_COMPONENT_OF_INTERSECTION", ERROR, SourceElementPositioningStrategies.DEFAULT, KtTypeReference::class)
    val NULLABLE_ON_DEFINITELY_NOT_NULLABLE: KtDiagnosticFactory0 = KtDiagnosticFactory0("NULLABLE_ON_DEFINITELY_NOT_NULLABLE", ERROR, SourceElementPositioningStrategies.DEFAULT, KtTypeReference::class)
    ...
    val WRONG_SETTER_PARAMETER_TYPE: KtDiagnosticFactory2<ConeKotlinType, ConeKotlinType> = KtDiagnosticFactory2("WRONG_SETTER_PARAMETER_TYPE", ERROR, SourceElementPositioningStrategies.DEFAULT, KtTypeReference::class)
    ...
    val WRONG_SETTER_RETURN_TYPE: KtDiagnosticFactory0 = KtDiagnosticFactory0("WRONG_SETTER_RETURN_TYPE", ERROR, SourceElementPositioningStrategies.DEFAULT, KtTypeReference::class)
    val WRONG_GETTER_RETURN_TYPE: KtDiagnosticFactory2<ConeKotlinType, ConeKotlinType> = KtDiagnosticFactory2("WRONG_GETTER_RETURN_TYPE", ERROR, SourceElementPositioningStrategies.DEFAULT, KtTypeReference::class)
    ...
    val IS_ENUM_ENTRY: KtDiagnosticFactory0 = KtDiagnosticFactory0("IS_ENUM_ENTRY", ERROR, SourceElementPositioningStrategies.DEFAULT, KtTypeReference::class)
    val DYNAMIC_NOT_ALLOWED: KtDiagnosticFactory0 = KtDiagnosticFactory0("DYNAMIC_NOT_ALLOWED", ERROR, SourceElementPositioningStrategies.DEFAULT, KtTypeReference::class)
    val ENUM_ENTRY_AS_TYPE: KtDiagnosticFactory0 = KtDiagnosticFactory0("ENUM_ENTRY_AS_TYPE", ERROR, SourceElementPositioningStrategies.SELECTOR_BY_QUALIFIED, KtTypeReference::class)
    ...
    val REDUNDANT_RETURN_UNIT_TYPE: KtDiagnosticFactory0 = KtDiagnosticFactory0("REDUNDANT_RETURN_UNIT_TYPE", WARNING, SourceElementPositioningStrategies.DEFAULT, KtTypeReference::class)
