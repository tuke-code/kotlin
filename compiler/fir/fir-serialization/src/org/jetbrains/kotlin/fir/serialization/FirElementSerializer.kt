                ...
                if (isFakeOverrideOfAnyFunctionInDataOrValueClass && !this@collectDeclarations.isExpect ||
                    ...
                    (
                            declaration.isStatic ||
                                    ...
                                    // The check (seems like) doesn't make sense,
                                    // but in the case of generating static declarations by a FIR plugin,
                                    // either resolver or klib metadata serializer can't handle a generated by plugin static method
                                    // as an example: [org.jetbrains.kotlinx.jspo.compiler.fir.JsPlainObjectsFunctionsGenerator]
                                    dispatchReceiverLookupTag == null ||
                                    dispatchReceiverLookupTag == this@collectDeclarations.symbol.toLookupTag()
                            )
                ) {
                    add(declaration)
                }
