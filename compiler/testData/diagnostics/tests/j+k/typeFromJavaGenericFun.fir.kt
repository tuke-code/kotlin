...
fun geneticFunTest() {
    ...
    takeString(<!ARGUMENT_TYPE_MISMATCH("kotlin.String; kotlin.String?")!>JavaWithGenericFun.foo4<String?>(JavaBox(JavaBox(""))).a.a<!>)
    ...
    takeString(<!ARGUMENT_TYPE_MISMATCH("kotlin.String; kotlin.String?")!>JavaWithGenericFun.foo4<String?>(JavaBox(JavaBox(null))).a.a<!>)
    ...
    takeString(<!ARGUMENT_TYPE_MISMATCH("kotlin.String; kotlin.String?")!>JavaWithGenericFun.foo6<String?>(JavaBox("")).a<!>)
    ...
    takeString(<!ARGUMENT_TYPE_MISMATCH("kotlin.String; kotlin.String?")!>JavaWithGenericFun.foo6<String?>(JavaBox(null)).a<!>)
}
