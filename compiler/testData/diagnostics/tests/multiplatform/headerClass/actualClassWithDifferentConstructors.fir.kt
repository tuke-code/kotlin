...
expect <!INCOMPATIBLE_MATCHING{JVM}!>class Bar1<!INCOMPATIBLE_MATCHING{JVM}!>()<!><!>
expect <!INCOMPATIBLE_MATCHING{JVM}!>class Bar2<!INCOMPATIBLE_MATCHING{JVM}!>()<!><!>
expect <!INCOMPATIBLE_MATCHING{JVM}!>class Bar3<!INCOMPATIBLE_MATCHING{JVM}!>()<!><!>
expect class Bar4()
expect class Bar5()
expect class Bar6()
