...
expect <!INCOMPATIBLE_MATCHING{JVM}, INCOMPATIBLE_MATCHING{JVM}!>fun foo2(x: Int)<!>

expect class NoArgConstructor()

expect <!INCOMPATIBLE_MATCHING{JVM}!>fun foo3(): Int<!>
expect <!INCOMPATIBLE_MATCHING{JVM}!>fun foo4(): Int<!>
