...
expect <!NO_ACTUAL_FOR_EXPECT{JVM}!>class CommonClass {
    fun memberFun()
    val memberProp: Int
    class Nested
    inner class Inner
...
expect <!NO_ACTUAL_FOR_EXPECT{JVM}!>fun commonFun()<!>
actual fun <!ACTUAL_WITHOUT_EXPECT!>commonFun<!>() {}

expect <!NO_ACTUAL_FOR_EXPECT{JVM}!>val commonProperty: String<!>
