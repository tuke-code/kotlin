...
@ClassArgAnn(ClassForReference::class)
actual <!ACTUAL_ANNOTATIONS_NOT_MATCH_EXPECT!>fun differentClassesWithSameName() {}<!>
...
@ArrayArgAnn(["foo"])
actual <!ACTUAL_ANNOTATIONS_NOT_MATCH_EXPECT!>fun arrayInAnnotationNotMatch() {}<!>
...
actual <!ACTUAL_ANNOTATIONS_NOT_MATCH_EXPECT!>fun complexNestedAnnotationsNotMatch() {}<!>
