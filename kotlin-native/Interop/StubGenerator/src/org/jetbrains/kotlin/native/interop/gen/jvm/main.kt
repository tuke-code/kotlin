...
private fun processCLib(
    ...
    val stubIrContext = StubIrContext(logger, configuration, nativeIndex, imports, flavor, mode, libName, plugin, prepareSourcesForExternalProcessing = nativeLibsDir == null)
