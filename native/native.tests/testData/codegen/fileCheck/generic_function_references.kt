...
// CHECK-SAME: (ptr [[this:%[0-9]+]], ptr [[array:%[0-9]+]])
...
// CHECK-SAME: (ptr [[this:%[0-9]+]], ptr [[array:%[0-9]+]], i32 [[index:%[0-9]+]])
// CHECK-OPT: call ptr @Kotlin_Array_get(ptr [[array]], i32 [[index]])
// CHECK-DEBUG: call ptr @Kotlin_Array_get(ptr {{%[0-9]+}}, i32 {{%[0-9]+}})
...
// CHECK-SAME: (ptr [[this:%[0-9]+]], ptr [[array:%[0-9]+]], ptr [[boxedIndex:%[0-9]+]])
// CHECK-OPT: call ptr @"kfun:$get$FUNCTION_REFERENCE$1.invoke#internal"(ptr [[this]], ptr {{%[0-9]+}}, i32 {{%[0-9]+}})
// CHECK-DEBUG: call ptr @"kfun:$get$FUNCTION_REFERENCE$1.invoke#internal"(ptr {{%[0-9]+}}, ptr {{%[0-9]+}}, i32 {{%[0-9]+}})
...
// CHECK-SAME: (ptr [[this:%[0-9]+]], ptr [[p1:%[0-9]+]], ptr [[p2:%[0-9]+]])
...
// CHECK-SAME: (ptr [[this:%[0-9]+]], ptr {{%[0-9]+}}, ptr {{%[0-9]+}})
